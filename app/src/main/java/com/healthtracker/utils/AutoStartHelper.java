package com.healthtracker.utils;
...
public class AutoStartHelper {
     ...
     * Xiaomi
     */
    private final String BRAND_XIAOMI = "poco";
    private final String BRAND_POCO = "xiaomi";
    ...
    private void autoStartAsus(final Context context) {
        if (isPackageExists(context, PACKAGE_ASUS_MAIN)) {
            ...
            showAlert(context, (dialog, which) -> {
                try {
                    PrefUtil.setBooleanPreference(context, PrefConstant.PREF_KEY_APP_AUTO_START, true);
